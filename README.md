...
_**NOTE:** The CZ Pellet Stove controller will soon be rewritten soon to run on a standard LilyGo T-Display S3 ESP32 just like the CZ Outdoor Monitor. The reason being, SD cards use in Raspberry Pi (and clone) SBCs have a limited lifespan and are guaranteed to fail in just a couple years. I've grown tired of the SD card surprises._
